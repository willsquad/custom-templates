<style>
    <?php include('files/css/latest_news.css'); ?>
</style>

<div id="latest_news" class="col-12">
    <div class="row max_width">
        <h2 class="col-12 section_title">Latest News</h2>

        <div class="col-lg-8 col-12 news_lhs">
            <!-- News Div -->
            <div class="row news_div">
                <div class="image_div col-lg-6 col-md-6 col-12">
        ...
        <div class="col-lg-4 col-12 news_rhs">
            <!-- News List Container -->
