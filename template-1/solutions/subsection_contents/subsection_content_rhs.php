<div class="subsection_rhs col-lg-9 col-md-8 col-12">

    <!-- -->
    <div class="main_image_container col-12">

        <div class="image_div">
            <img src="solutions/files/images/energy_img1.jpg" alt="">
        </div>
        ...
        <div class="row">
            <div class="image_side col-12 col-md-5 push-md-7 col-lg-4 push-lg-8">
                <img src="solutions/files/images/about_service_img.jpg" alt="">
            </div>
            <div class="text_content col-12 col-md-7 pull-md-5 col-lg-8 pull-lg-4">
